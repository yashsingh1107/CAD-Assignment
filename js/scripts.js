  ...
  $("button.proceed").click(function(event){
   ...
   switch(pcrust){
    ...
    if((psize == "0") && (pcrust == "0")){
      ...
      $("#info").show();
      $("div.choice").hide();
      alert("Dear customer, some required fields are empty!"); 
    }
    else{
      $("button.proceed").hide();
      $("#info").hide();
    ...
    $("button#checkout").click(function(){ 
      ...
      console.log("Your total bills is rupees "+checkoutTotal);
      $("#pizzatotal").append("Your bill is rupees "+checkoutTotal);
    });
    ...
    $("button.deliver").click(function(){
      ...
      console.log("You will pay rupees "+deliveryamount+" on pick-up");
      $("#totalbill").append("Your bill + pick-up fee is: "+deliveryamount);
    });
